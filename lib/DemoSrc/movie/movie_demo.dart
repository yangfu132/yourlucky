...
import 'package:yourlucky/DemoSrc/movie/movie.dart';
...
final moviesRef = FirebaseFirestore.instance
    .collection('com.kongyilanlan.yourlucky')
    .withConverter<Movie>(
...
class _FilmListState extends State<FilmList> {
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          PopupMenuButton<String>(
            onSelected: (String strValue) => onItemSelected(strValue),
            itemBuilder: (BuildContext context) {
              return [
                const PopupMenuItem(
                  value: 'reset_likes',
  ...
  void onItemSelected(String strValue) {
    if ('reset_likes' == strValue) {
      _resetLikes();
    } else if ('add_data' == strValue) {
      moviesRef.add(
        Movie(
            ...
            likes: 0,
            poster:
                'https://img2.baidu.com/it/u=768796266,4241641305&fm=26&fmt=auto&gp=0.jpg',
            rated: 'rated',
            runtime: 'runtime',
            year: 2021),
      );
