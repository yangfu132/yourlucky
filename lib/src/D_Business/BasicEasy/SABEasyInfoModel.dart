...
//
import 'package:your_lucky/src/D_Business/Base/SABBaseModel.dart';
import 'package:your_lucky/src/D_Business/BasicEasy/SABEasyInfoSymbolModel.dart';
...
class SABEasyInfoModel extends SABBaseModel {
  ...
  void aaa() {
    SABEasyInfoSymbolModel symbol1 = SABEasyInfoSymbolModel(
        textClassical: "初九，潜龙勿用。",
        textTranslate: "初九，龙尚潜伏在水中，养精蓄锐，暂时还不能发挥作用。",
        likeClassical: "《象》曰：潜龙勿用，阳在下也。",
        likeTranslate:
            "《象辞》说：龙象征阳。\"龙尚潜伏在水中，养精蓄锐，暂时还不能发挥作用\"，是因为此爻位置最低，阳气不能散发出来的缘故。");
    SABEasyInfoSymbolModel symbol2 = SABEasyInfoSymbolModel(
        textClassical: "九二，见龙在田，利见大人。",
        textTranslate: "九二，龙已出现在地上，利于出现德高势隆的大人物。",
        likeClassical: "《象》曰：\"见龙在田\"，德施普也。",
        likeTranslate: "《象辞》说：\"龙已出现在地上\"，犹如阳光普照，天下人普遍得到恩惠。");
    SABEasyInfoSymbolModel symbol3 = SABEasyInfoSymbolModel(
        textClassical: "九三，君子终日乾乾，夕惕若，厉无咎。",
        textTranslate: "九三，君子整天自强不息，晚上也不敢有丝毫的懈怠，这样即使遇到危险也会逢凶化吉。",
        likeClassical: "《象》曰：\"终日乾乾\"，反复道也。",
        likeTranslate: "《象辞》说：\"整天自强不息\"，是因为要避免出现反复，不敢有丝毫大意。");
    SABEasyInfoSymbolModel symbol4 = SABEasyInfoSymbolModel(
        textClassical: "九四，或跃在渊，无咎。",
        textTranslate: "九四，龙或腾跃而起，或退居于渊，均不会有危害。",
        likeClassical: "《象》曰：\"或跃在渊\"，进无咎也。",
        likeTranslate: "《象辞》说：\"龙或腾跃而起，或退居于渊，均不会有危害\"，因为能审时度势，故进退自如，不会有危害。");
    SABEasyInfoSymbolModel symbol5 = SABEasyInfoSymbolModel(
        textClassical: "九五，飞龙在天，利见大人。",
        textTranslate: "九五，龙飞上了高空，利于出现德高势隆的大人物。",
        likeClassical: "《象》曰：\"飞龙在天\"，大人造也。",
        likeTranslate: "《象辞》说：\"龙飞上了高空\"，象征德高势隆的大人物一定会有所作为。");
    SABEasyInfoSymbolModel symbol6 = SABEasyInfoSymbolModel(
        textClassical: "上九，亢龙有悔。",
        textTranslate: "上九，龙飞到了过高的地方，必将会后悔。",
        likeClassical: "《象》曰：\"亢龙有悔\"，盈不可久也。",
    ...
    dictionary["111111"] = {
      ...
      "textTranslate": "《乾卦》象征天：元始，亨通，和谐，贞正。",
      "likeClassical": "《象》曰：天行健，君子以自强不息。",
