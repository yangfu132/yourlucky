...
import 'package:your_lucky/src/D_Business/EasyWords/sab_common_words_business.dart';
...
import '../BasicEasy/sab_diagrams_info_model.dart';
import '../BasicEasy/sab_element_info_model.dart';
import 'sab_easy_words_model.dart';
...
class SABEasyWordsBusiness extends SABBaseBusiness {
  ...
  String symbolAtToRow(int intIndex) {
    ...
    if (0 <= intIndex && intIndex <= 5) {
      ...
      stringResult = toSymbol.replaceRange(
          toSymbol.length - 4, toSymbol.length - 2, strValue);
    } else {
