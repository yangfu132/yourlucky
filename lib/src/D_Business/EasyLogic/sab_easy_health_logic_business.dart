...
import 'BaseLogic/sab_common_logic_business.dart';
...
class SABEasyHealthLogicBusiness extends SABBaseBusiness {
  ...
  List moveRightArray() {
    return healthBusiness().rowsAtOutRightLevel(OutRightEnum.rightTypeMove);
  }
...
//绝
  ...
  bool isFalseEmptyAtRow(int symbolRow, EasyTypeEnum easyType) {
    ...
    if (easyType == EasyTypeEnum.from) {
      //动不为空；
      final outright = healthModel().symbolOutRightUnEmptyAtRow(symbolRow, easyType);
