...
import 'package:your_lucky/src/D_Business/EasyLogic/Health/SABEasyHealthBusiness.dart';
...
import 'package:your_lucky/src/D_Business/EasyLogic/Health/SABHealthSymbolModel.dart';
...
import 'package:your_lucky/src/D_Business/EasyLogic/SABHealthLogicSymbolModel.dart';
  ...
  double usefulHealth() {
    ...
    if (EasyTypeEnum.from == deityModel.easyType ||
      ...
      coLog(StackTrace.current, LogTypeEnum.error,
          "EasyTypeEnum.to do not have usefulDeity");
    } else {}
