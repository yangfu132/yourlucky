...
void main() {
  ...
  test('bMovement', () {
    ...
    wordsModel = generateWords([0, 8, 0, 1, 1, 1]);
    ...
    wordsModel = generateWords([8, 8, 0, 8, 0, 0]);
    ...
    wordsModel = generateWords([0, 1, 1, 8, 8, 1]);
    expect(wordsModel.rowModelAtRow(0).bMovement, false);
...
SABEasyWordsModel generateWords(List<int> listEasyData) {
